...
const AnimalListPageComponent: React.FC<AnimalListPageProps> = ({ animals, pens }) => {
  ...
  const updateAnimalFields = (animal: Animal, data: AnimalFormData) => {
    ...
    animal.currentPenId = data.currentPenId || undefined;
    animal.electronicId = data.electronicId || undefined;
    animal.visualId = data.visualId || undefined;
    animal.geneticLine = data.geneticLine || undefined;
    animal.purpose = data.purpose || undefined;
    animal.origin = data.origin || undefined;
    animal.acquisitionCost = Number(data.acquisitionCost) || 0;
    animal.notes = data.notes || undefined;
    animal.breedId = data.breedId || undefined;
