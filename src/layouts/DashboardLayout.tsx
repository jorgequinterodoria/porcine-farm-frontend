...
export const DashboardLayout: React.FC = () => {
  ...
  const farmAdminNavItems = [
    ...
    { name: 'Alimentación', path: '/feeding', icon: CalendarDays },
    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      <aside className={cn(
        ...
        <div className="p-4 border-t border-gray-100 bg-gray-50/50">
          <div className="flex items-center gap-3 mb-4 p-3 rounded-xl bg-white border border-gray-200 shadow-sm">
      ...
      <main className="flex-1 min-w-0 transition-all duration-300">
        {/* Padding superior extra en móvil para compensar el header fijo */}
